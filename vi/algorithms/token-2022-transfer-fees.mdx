...
<Info>
  Ma trận hỗ trợ: **CPMM** hỗ trợ Token-2022 đầy đủ, bao gồm mint có phí chuyển. **CLMM** hỗ trợ Token-2022 với phí chuyển thông qua account `SwapV2` rõ ràng. **AMM v4** hoàn toàn không hỗ trợ Token-2022. **LaunchLab** tạo mint cơ sở SPL cổ điển thông qua `InitializeV2`, nhưng có một entrypoint riêng `InitializeWithToken2022` tạo mint cơ sở Token-2022 và tùy chọn gắn kèm một `TransferFeeConfig`; phía quote của nó chấp nhận cả hai token program. Xem [`products/launchlab/platform-config`](/vi/products/launchlab/platform-config#token-2022-transfer-fee-authorities). **Farm v6** hỗ trợ Token-2022 trên cả mint đặt cọc và mint phần thưởng.
</Info>
...
≈ 986.03 USDC. Không có phí chuyển outbound, vì vậy người dùng nhận được ≈ 986.03 USDC.
...
- [Tài liệu extension phí chuyển SPL Token-2022](https://www.solana-program.com/docs/token-2022/extensions#transfer-fees)
