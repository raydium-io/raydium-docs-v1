...
Xem [trang tiện ích Token-2022 chính thức](https://www.solana-program.com/docs/token-2022/extensions) để xem danh sách đầy đủ.
...
- [Token-2022 docs](https://www.solana-program.com/docs/token-2022) — tổng quan về chương trình; danh sách tiện ích đầy đủ nằm tại [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions).
- [Associated Token Account](https://www.solana-program.com/docs/associated-token-account).
