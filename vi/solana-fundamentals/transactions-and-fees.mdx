...
SDK đóng gói các instruction này tự động — thông qua trình xây dựng riêng của từng loại pool (`raydium.cpmm.swap`, `raydium.clmm.swap`, `raydium.liquidity.swap`), hoặc `raydium.tradeV2.swap` cho một tuyến đường đa bước.
