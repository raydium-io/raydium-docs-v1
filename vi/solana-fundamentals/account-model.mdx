...
// Bố cục được xuất ra là CpmmPoolInfoLayout, và nó đã tính đến
// discriminator 8 byte — đừng cắt bỏ nó.
...
- [Tài liệu Solana Account](https://solana.com/docs/core/accounts).
- [SPL Token program](https://www.solana-program.com/docs/token) — nơi các tài khoản token sống.
