...
- **Xác minh:** 2026-09-09 — pipeline bên dưới khớp từng lệnh gọi với [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts) dựa trên SDK `0.2.64-alpha`
