...
| Tài khoản | Seed(s) | Chủ sở hữu | Mục đích |
|---------|---------|-------|---------|
| `creatorFeeShare` | `"creator_fee_share"`, `creator`, `ammConfig` | CPMM | Ghi đè `AmmConfig.creator_fee_share_rate` cho một người tạo pool trên một tầng phí. Tùy chọn — khi nó không tồn tại, mặc định cấu hình được áp dụng. Được thêm bởi bản nâng cấp creator-fee-share ngày 2026-09-13. |
...
Một tài khoản tùy chọn ghi đè phần chia của giao thức về phí người tạo cho một cặp `(pool creator, AmmConfig)`. Được thêm bởi bản nâng cấp creator-fee-share ngày 2026-09-13.
