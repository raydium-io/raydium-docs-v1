...
Các pool CLMM của Raydium thường thấy ít hoạt động sandwich hơn CPMM vì cấu trúc thanh khoản một tick duy nhất có nghĩa là những giao dịch nhỏ hoàn toàn không di chuyển giá (chúng ở trong tick). Các pool CLMM sâu là địa điểm kháng sandwich tốt nhất hữu cơ.
...
- [Tài liệu Solana về phí giao dịch và phí ưu tiên](https://solana.com/docs/core/fees)
