...
- **Bug bounty của validator Agave (Anza)** — bao gồm các lỗi validator client của Solana (consensus, an toàn, tính sống, DoS). Báo cáo ở đó cho các vấn đề ở lớp Solana; các chương trình SPL và các tài sản web nằm ngoài phạm vi một cách rõ ràng. [Chính sách bảo mật Agave](https://github.com/anza-xyz/agave/security/policy).
- **Squads Protocol Bug Bounty** — bao gồm chính multisig. [docs.squads.so/main/security/bug-bounty](https://docs.squads.so/main/security/bug-bounty).
