...
In every other case, **launch new pools on CPMM.** See [`user-flows/cpmm-vs-clmm`](/user-flows/cpmm-vs-clmm) for the full decision tree.
...
- [`user-flows/cpmm-vs-clmm`](/user-flows/cpmm-vs-clmm) — decision tree for new pool deployments.
