...
<CardGroup cols={2}>
  <Card title="Download white paper (PDF)" icon="file-pdf" href="https://raydium-io.github.io/raydium-docs-v1/whitepaper/raydium-protocol-ray-token-white-paper.pdf">
    Full document, 27 pages (~350 KB).
  </Card>
  <Card title="Original iXBRL file (.xhtml)" icon="file-code" href="https://raydium-io.github.io/raydium-docs-v1/whitepaper/raydium-protocol-ray-token-white-paper.xhtml">
