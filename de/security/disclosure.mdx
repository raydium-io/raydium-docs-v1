...
- **Agave-Validator-Bug-Bounty (Anza)** – deckt Fehler im Solana-Validator-Client ab (Consensus, Safety, Liveness, DoS). Berichten Sie dort für Probleme auf Solana-Ebene; SPL-Programme und Web-Angebote sind ausdrücklich außerhalb des Umfangs. [Agave-Sicherheitsrichtlinie](https://github.com/anza-xyz/agave/security/policy).
- **Squads Protocol Bug Bounty** – deckt die Multisig selbst ab. [docs.squads.so/main/security/bug-bounty](https://docs.squads.so/main/security/bug-bounty).
