...
Das SDK packt diese automatisch — über den eigenen Builder des jeweiligen Pool-Typs (`raydium.cpmm.swap`, `raydium.clmm.swap`, `raydium.liquidity.swap`) oder über `raydium.tradeV2.swap` für eine Multi-Hop-Route.
