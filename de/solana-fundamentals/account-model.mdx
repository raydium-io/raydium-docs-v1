...
// Das exportierte Layout ist CpmmPoolInfoLayout, und es berücksichtigt bereits den
// 8-Byte-Diskriminator — schneiden Sie ihn nicht ab.
...
- [Solana Account-Dokumentation](https://solana.com/docs/core/accounts).
- [SPL-Token-Programm](https://www.solana-program.com/docs/token) — wo Token-Konten leben.
