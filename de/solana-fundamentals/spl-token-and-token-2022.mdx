...
Siehe die [offizielle Token-2022-Extensions-Seite](https://www.solana-program.com/docs/token-2022/extensions) für die vollständige Liste.
...
- [Token-2022 Docs](https://www.solana-program.com/docs/token-2022) – die Programmübersicht; die vollständige Extension-Liste steht unter [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions).
