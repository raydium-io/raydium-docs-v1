...
| Konto | Seed(s) | Besitzer | Zweck |
|---------|---------|-------|---------|
| `creatorFeeShare` | `"creator_fee_share"`, `creator`, `ammConfig` | CPMM | Überschreibt `AmmConfig.creator_fee_share_rate` für einen Pool-Creator auf einem Gebühren-Tier. Optional — wenn es nicht existiert, gilt der Config-Standard. Hinzugefügt durch das Upgrade vom 2026-09-13 für Creator-Fee-Share. |
...
Ein optionales Konto, das den Protokoll-Anteil der Creator-Gebühr für ein `(Pool-Creator, AmmConfig)`-Paar überschreibt. Hinzugefügt durch das Upgrade vom 2026-09-13 für Creator-Fee-Share.
