...
<Info>
  **Versionsbanner.** Alle Beispiele zielen auf `@raydium-io/raydium-sdk-v2@0.2.64-alpha` gegen Solana mainnet-beta, verifiziert 2026-04. Das SDK versendet intern v3 / v5 / v6 basierend auf dem Programmeigentümer der Farm; die Beispiele unten setzen eine v6-Farm voraus. Siehe [`reference/program-addresses`](/de/reference/program-addresses) für die drei Programm-IDs.
</Info>
