...
<Info>
  **Versionsbanner.** Alle Demos zielen auf `@raydium-io/raydium-sdk-v2@0.2.64-alpha` gegen Solana mainnet-beta ab, verifiziert 2026-04. Program IDs stammen aus [`reference/program-addresses`](/de/reference/program-addresses) über das SDK.
</Info>
