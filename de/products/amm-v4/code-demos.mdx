...
<Info>
  **Versionsbanner.** Alle Demos zielen auf `@raydium-io/raydium-sdk-v2@0.2.64-alpha` gegen Solana mainnet-beta ab, verifiziert 2026-04. Programm-ID: `675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8` (siehe [`reference/program-addresses`](/de/reference/program-addresses)).
</Info>
