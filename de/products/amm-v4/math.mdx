...
- Gebühren: Standard `swap_fee = 25/10_000` (0,25% des Volumens) und `pnl = 12/100` — das gespeicherte `Fees`-Verhältnis ist 12/100, also 12% *der Swap-Gebühr*, was 0,03% des Volumens ergibt.
...
pnl_share = 2_500_000 * 12 / 100 = 300_000    (geht zum Protokoll über need_take_pnl_coin)
lp_share  = 2_500_000 − 300_000  = 2_200_000  (bleibt in coin_reserve)
