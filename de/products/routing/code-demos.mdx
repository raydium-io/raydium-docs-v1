...
- **Verifiziert:** 2026-09-09 — die Pipeline unten entspricht [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts) Aufruf für Aufruf gegen SDK `0.2.64-alpha`
