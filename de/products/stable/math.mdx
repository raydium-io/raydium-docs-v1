...
Gleiche Arithmetik wie bei AMM v4 — siehe [`products/amm-v4/math`](/de/products/amm-v4/math) für die vollständige Herleitung — aber mit den eigenen Zahlen der Stable-Pools.

```
gross_fee = amount_in * (swap_fee_numerator / swap_fee_denominator)    // 2/10_000 = 0.02%
lp_portion = gross_fee - (gross_fee * pnl_numerator / pnl_denominator) // 88% davon = 0.0176%
pnl_portion = gross_fee * (pnl_numerator / pnl_denominator)            // 12% davon = 0.0024%
```
