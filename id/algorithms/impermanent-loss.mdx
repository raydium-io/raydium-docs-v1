...
Asumsikan Anda menyetor \$10.000 SOL/USDC ke CLMM pada SOL = \$160, rentang `[$120, $200]`. Perhatikan bahwa setoran ini **bukan** 50/50: pada harga itu dalam rentang tersebut posisi mengambil 27.54 SOL (\$4.407) dan \$5.593 USDC, yang menetapkan `L ≈ 3,300`. Tolok ukur HODL di bawah adalah kepemilikan 50/50 \$5.000 + \$5.000, sesuai dengan perbandingan CPMM.

- Lebar rentang: `P_hi / P_lo = 200 / 120 ≈ 1.67`. Faktor leverage ≈ `1 / (1 − √(120/200)) ≈ 4.4×`.
- Jika SOL bergerak ke \$180 (+12.5%), nilai HODL = \$10.625; posisi CLMM ≈ \$10.397; **IL ≈ 2.1%**.
- Jika SOL bergerak ke \$200 (+25%), nilai HODL = \$11.250; posisi CLMM sekarang 100% USDC bernilai ≈ \$10.520; **IL ≈ 6.5%**.
- Jika SOL bergerak ke \$240 (+50%, di luar rentang), nilai HODL = \$12.500; posisi CLMM masih ≈ \$10.520; **IL ≈ 15.8%**.

Modal yang sama dalam CPMM (tanpa rentang) hanya akan memiliki IL ~2.02% pada \$240 dan terus memperoleh biaya. Selisih itu adalah amplifikasi yang dibuka halaman ini: kira-kira faktor leverage dikali IL CPMM selama masih dalam rentang. Posisi CLMM memiliki penangkapan biaya lebih tinggi *saat dalam rentang* tetapi IL jauh lebih buruk setelah keluar dari rentang untuk waktu yang lama.
...
- [`sdk-api/typescript-sdk`](/id/sdk-api/typescript-sdk) — `raydium.clmm.getOwnerPositionInfo({ programId })` ditambah `PoolUtils.getAmountsFromLiquidity(...)` mengembalikan exposure saat ini; beda dengan basis entry Anda.
