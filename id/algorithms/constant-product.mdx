...
pnl_share = swap_fee · pnl_numerator / pnl_denominator               // 12 / 100 = 12% dari swap_fee
...
Harga efektif: `1000 / 1993.01 ≈ 0.5018`. Spot sebelumnya: `0.5`. Slippage terhadap spot: **~0.35%**. Price impact — pergerakan harga spot pool itu sendiri, sesuai definisi di atas — adalah **~0.20%**.
...
Efektif: `100_000 / 181_405 ≈ 0.5513`. Slippage terhadap spot: **~10.3%**. Price impact: **~17.3%** — dekat dengan aturan praktis `2 · 10% = 20%`, yang ditarik sedikit ke bawah oleh fee trade dan inversi kurva. Kedua angka ini sering tertukar: slippage adalah apa yang dibayar swapper relatif terhadap spot, price impact adalah seberapa jauh kutipan pool itu sendiri bergerak.
