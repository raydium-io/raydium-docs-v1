...
<Info>
  Matriks dukungan: **CPMM** mendukung Token-2022 sepenuhnya, termasuk mint dengan transfer fee. **CLMM** mendukung Token-2022 dengan transfer fee melalui akun `SwapV2` eksplisit. **AMM v4** tidak mendukung Token-2022 sama sekali. **LaunchLab** membuat base mint SPL klasik melalui `InitializeV2`, tetapi memiliki entrypoint khusus `InitializeWithToken2022` yang membuat base mint Token-2022 dan secara opsional melampirkan `TransferFeeConfig`; sisi quote-nya menerima salah satu token program. Lihat [`products/launchlab/platform-config`](/id/products/launchlab/platform-config#token-2022-transfer-fee-authorities). **Farm v6** mendukung Token-2022 pada mint staking dan reward.
</Info>
...
- [Dokumen extension transfer-fee SPL Token-2022](https://www.solana-program.com/docs/token-2022/extensions#transfer-fees)
