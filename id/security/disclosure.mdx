...
- **Bug bounty validator Agave (Anza)** — mencakup bug klien validator Solana (consensus, safety, liveness, DoS). Laporkan di sana untuk masalah lapisan Solana; program SPL dan properti web secara eksplisit berada di luar cakupan. [Kebijakan keamanan Agave](https://github.com/anza-xyz/agave/security/policy).
- **Squads Protocol Bug Bounty** — mencakup multisig itu sendiri. [docs.squads.so/main/security/bug-bounty](https://docs.squads.so/main/security/bug-bounty).
