...
Aritmetika yang sama dengan AMM v4 — lihat [`products/amm-v4/math`](/id/products/amm-v4/math) untuk penurunan lengkap — tetapi dengan angka-angka milik pool Stable sendiri.

```
gross_fee = amount_in * (swap_fee_numerator / swap_fee_denominator)    // 2/10_000 = 0.02%
lp_portion = gross_fee - (gross_fee * pnl_numerator / pnl_denominator) // 88% dari itu = 0.0176%
pnl_portion = gross_fee * (pnl_numerator / pnl_denominator)            // 12% dari itu = 0.0024%
```
