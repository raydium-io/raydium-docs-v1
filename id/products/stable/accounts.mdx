...
pub struct Fees {
    ...
    pub trade_fee_numerator: u64,       // 0 (bidang OpenBook warisan, tidak dipakai)
    pub trade_fee_denominator: u64,     // 10_000
    pub pnl_numerator: u64,             // 12
    pub pnl_denominator: u64,           // 100 → 12% dari biaya = 0.0024% dari volume
...
- **`fees`** — *struktur* identik dengan AMM v4, *nilai* berbeda: `swap_fee = 2 / 10_000` (0.02%), `pnl = 12 / 100`, `trade_fee = 0`. Lihat [`products/stable/fees`](/id/products/stable/fees).
