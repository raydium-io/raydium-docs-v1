...
- Biaya: default `swap_fee = 25/10_000` (0.25% dari volume) dan `pnl = 12/100` — rasio `Fees` yang tersimpan adalah 12/100, yaitu 12% *dari biaya swap*, yang setara dengan 0.03% dari volume.
...
pnl_share = 2_500_000 * 12 / 100 = 300_000    (ke protokol via need_take_pnl_coin)
lp_share  = 2_500_000 − 300_000  = 2_200_000  (tetap di coin_reserve)
