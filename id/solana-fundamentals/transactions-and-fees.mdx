...
SDK mengemas instruksi ini secara otomatis — melalui builder milik tipe pool itu sendiri (`raydium.cpmm.swap`, `raydium.clmm.swap`, `raydium.liquidity.swap`), atau `raydium.tradeV2.swap` untuk route multi-hop.
