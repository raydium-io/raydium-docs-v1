...
// Layout yang diekspor adalah CpmmPoolInfoLayout, dan sudah memperhitungkan
// diskriminator 8-byte — jangan memotongnya.
...
- [Dokumen Akun Solana](https://solana.com/docs/core/accounts).
- [Program SPL Token](https://www.solana-program.com/docs/token) — di mana akun token hidup.
