...
プログラムごとの回収アドレスは [プロトコル手数料回収ウォレット](/ja/reference/program-addresses#protocol-fee-collection-wallets) の下に一覧されています。
...
両クラスターの受取アドレスは [プール作成手数料の受取先](/ja/reference/program-addresses#pool-creation-fee-receivers) の下に一覧されています。
