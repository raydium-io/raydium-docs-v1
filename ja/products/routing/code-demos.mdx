...
- **検証済み:** 2026-09-09 — 以下のパイプラインは SDK `0.2.64-alpha` に対して [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts) と呼び出し単位で一致します
