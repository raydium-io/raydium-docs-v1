...
- フィー：デフォルトは `swap_fee = 25/10_000`（ボリュームの 0.25%）と `pnl = 12/100` — 格納されている `Fees` の比率は 12/100、つまり *スワップフィーの* 12% であり、ボリュームの 0.03% に相当します。
...
pnl_share = 2_500_000 * 12 / 100 = 300_000    (プロトコルへ need_take_pnl_coin 経由)
lp_share  = 2_500_000 − 300_000  = 2_200_000  (coin_reserve に留まる)
