...
<CardGroup cols={2}>
  ...
  <Card title="フィー" icon="percent" href="/ja/products/stable/fees">
    総トレード フィー 0.02%、0.0176% LP / 0.0024% プロトコルに分割。ファンド フィーなし、クリエーター フィーなし。
  </Card>
...
| **トレード フィー** | 0.02%（AMM v4 の 0.25% ではない） |
| **LP のフィー シェア** | 0.0176%（フィーの 88%） |
| **プロトコル のフィー シェア** | 0.0024%（フィーの 12%） |
| **クリエーター フィー** | なし |
| **ファンド フィー** | なし |
