...
完全なリストについては、[公式 Token-2022 拡張機能ページ](https://www.solana-program.com/docs/token-2022/extensions)を参照してください。
...
- [SPL Token ドキュメント](https://www.solana-program.com/docs/token)。
- [Token-2022 ドキュメント](https://www.solana-program.com/docs/token-2022) — プログラムの概要。完全な拡張機能リストは [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions) にあります。
