...
- Each intermediate ATA must already exist on-chain. If it does not, create it ahead of time — typically via the [SPL Associated Token Account program](https://www.solana-program.com/docs/associated-token-account), or with `CreateSyncNative` (tag 5) for a wSOL ATA.
