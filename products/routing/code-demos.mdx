...
- **Verified:** 2026-09-09 — the pipeline below matches [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts) call-for-call against SDK `0.2.64-alpha`
