...
<CardGroup cols={2}>
  ...
  <Card title="Instructions" icon="terminal" href="/products/launchlab/instructions">
    Initialize variants, the four trade instructions, fee claims, vesting. Includes the permissioned migration instructions.
  </Card>
  <Card title="Code demos" icon="code" href="/products/launchlab/code-demos">
    End-to-end: deploy a launch, buy/sell, track graduation, verify the resulting pool.
  </Card>
