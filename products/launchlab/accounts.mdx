...
| (post-graduation) Fee Key NFT | LP-Lock program | Before the 2026-08-14 upgrade, platform and creator scales could produce separate Fee Keys. Migrations executed afterward combine both scales into one platform Fee Key. |
