...
3. Before the 2026-08-17 upgrade, `creatorScale` produced a creator-owned Fee Key. Migrations executed afterward combine the stored platform and creator scales into one platform-owned locked-LP share. The remaining share is burned.
