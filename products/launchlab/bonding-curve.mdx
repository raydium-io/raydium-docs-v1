...
Same 10 USDC buys far less base now because the curve is steep. Solving at `s₀ = 750e6` with `quote_in_after_fee = 9.9e6` gives `∆s ≈ 4.4e5` — a **~200×** reduction in base per USDC compared to the first buy.
