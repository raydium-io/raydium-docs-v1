...
| `trade_fee_numerator / trade_fee_denominator` | `25 / 10_000` | Vestigial after the OpenBook removal (historically used for limit-order pricing). Same `0.25%` as `swap_fee` by default. |
