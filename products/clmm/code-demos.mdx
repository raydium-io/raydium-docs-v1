...
<Info>
  **Version banner.** All demos target `@raydium-io/raydium-sdk-v2@0.2.64-alpha` against Solana mainnet-beta, verified 2026-04. Program IDs come from [`reference/program-addresses`](/reference/program-addresses) via the SDK.
</Info>
