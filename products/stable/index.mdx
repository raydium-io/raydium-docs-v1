...
<CardGroup cols={2}>
  ...
  <Card title="Fees" icon="percent" href="/products/stable/fees">
    0.02% gross trade fee, split 0.0176% LP / 0.0024% protocol. No fund fee, no creator fee.
  </Card>
...
| **Trade fee** | 0.02% (not AMM v4's 0.25%) |
| **LP share of fee** | 0.0176% (88% of the fee) |
| **Protocol share of fee** | 0.0024% (12% of the fee) |
| **Creator fee** | None |
| **Fund fee** | None |
