...
description: "AmmInfo, ModelDataInfo, DataElement, Fees, vault layout, and OpenBook accounts. The full account inventory of a Stable AMM pool."
---
...
- **OpenBook account derivation**: OpenBook program docs.
