...
전체 목록은 [공식 Token-2022 확장 기능 페이지](https://www.solana-program.com/docs/token-2022/extensions)를 참조하세요.
...
- [SPL 토큰 문서](https://www.solana-program.com/docs/token).
- [Token-2022 문서](https://www.solana-program.com/docs/token-2022) — 프로그램 개요이며, 전체 확장 기능 목록은 [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions)에 있습니다.
- [관련 토큰 계정](https://www.solana-program.com/docs/associated-token-account).
