...
<Info>
  **버전 배너.** 모든 예제는 Solana mainnet-beta에 대해 `@raydium-io/raydium-sdk-v2@0.2.64-alpha`를 대상으로 하며, 2026년 4월에 검증되었습니다. 프로그램 ID: `675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8` ([`reference/program-addresses`](/ko/reference/program-addresses) 참조).
</Info>
