...
AMM v4와 동일한 산술이지만 — 전체 유도는 [`products/amm-v4/math`](/ko/products/amm-v4/math)를 참조하세요 — Stable 풀 자체의 숫자를 사용합니다.

```
gross_fee = amount_in * (swap_fee_numerator / swap_fee_denominator)    // 2/10_000 = 0.02%
lp_portion = gross_fee - (gross_fee * pnl_numerator / pnl_denominator) // 88% of it = 0.0176%
pnl_portion = gross_fee * (pnl_numerator / pnl_denominator)            // 12% of it = 0.0024%
```
