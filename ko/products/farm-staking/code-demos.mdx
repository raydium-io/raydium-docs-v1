...
<Info>
  **버전 정보.** 모든 데모는 Solana mainnet-beta에 대해 `@raydium-io/raydium-sdk-v2@0.2.64-alpha`를 대상으로 하며 2026년 4월에 검증되었습니다. SDK는 팜의 프로그램 오너를 기반으로 내부적으로 v3 / v5 / v6을 디스패치합니다. 아래 예제는 v6 팜을 가정합니다. 세 프로그램 ID는 [`reference/program-addresses`](/ko/reference/program-addresses)를 참조하세요.
</Info>
