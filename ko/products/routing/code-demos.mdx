...
- **검증 완료:** 2026-09-09 — 아래 파이프라인은 SDK `0.2.64-alpha`에 대해 [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts)와 호출 단위로 일치합니다
