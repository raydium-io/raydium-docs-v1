...
El SDK las empaca automáticamente — mediante el constructor propio del tipo de pool (`raydium.cpmm.swap`, `raydium.clmm.swap`, `raydium.liquidity.swap`), o `raydium.tradeV2.swap` para una ruta multi-salto.
...
// (Para una ruta multi-salto usa raydium.tradeV2.swap, que devuelve `transactions`
//  — un arreglo — y cuyo execute() necesita { sequentially: true }.)
```
...
- [Documentación de transacciones de Solana](https://solana.com/docs/core/transactions).
- [Guía del cookbook sobre tablas de búsqueda de direcciones](https://solana.com/developers/cookbook/transactions/lookup-tables).
- [Documentación de presupuesto de cómputo](https://solana.com/docs/core/fees).
