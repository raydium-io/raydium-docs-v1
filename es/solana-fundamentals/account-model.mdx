...
// El diseño exportado es CpmmPoolInfoLayout, y ya tiene en cuenta el
// discriminador de 8 bytes — no lo recortes.
...
- [Documentos de Cuentas de Solana](https://solana.com/docs/core/accounts).
- [Programa SPL Token](https://www.solana-program.com/docs/token) — donde viven las cuentas de token.
