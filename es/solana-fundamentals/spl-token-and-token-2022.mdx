...
Consulta la [página oficial de extensiones de Token-2022](https://www.solana-program.com/docs/token-2022/extensions) para la lista completa.
...
- [Documentación de SPL Token](https://www.solana-program.com/docs/token).
- [Documentación de Token-2022](https://www.solana-program.com/docs/token-2022) — la descripción general del programa; la lista completa de extensiones está en [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions).
- [Cuenta de Token Asociada](https://www.solana-program.com/docs/associated-token-account).
