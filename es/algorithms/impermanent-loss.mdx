...
Supongamos que depositas \$10,000 de SOL/USDC en un CLMM a SOL = \$160, rango `[$120, $200]`. Ten en cuenta que el depósito **no** es 50/50: a ese precio y en ese rango la posición toma 27.54 SOL (\$4,407) y \$5,593 USDC, lo que fija `L ≈ 3,300`. El punto de referencia HODL de más abajo es una tenencia 50/50 de \$5,000 + \$5,000, coincidiendo con la comparación CPMM.

- Ancho de rango: `P_hi / P_lo = 200 / 120 ≈ 1.67`. Factor de apalancamiento ≈ `1 / (1 − √(120/200)) ≈ 4.4×`.
- Si SOL se mueve a \$180 (+12.5%), valor HODL = \$10,625; posición CLMM ≈ \$10,397; **IL ≈ 2.1%**.
- Si SOL se mueve a \$200 (+25%), valor HODL = \$11,250; la posición CLMM ahora es 100% USDC que vale ≈ \$10,520; **IL ≈ 6.5%**.
- Si SOL se mueve a \$240 (+50%, fuera de rango), valor HODL = \$12,500; la posición CLMM sigue siendo ≈ \$10,520; **IL ≈ 15.8%**.

El mismo capital en un CPMM (sin rango) habría tenido IL de solo ~2.02% a \$240 y continuaría ganando comisiones. Esa brecha es la amplificación con la que abre esta página: aproximadamente el factor de apalancamiento por la IL del CPMM mientras está en rango. La posición CLMM captura más comisiones *mientras está en rango* pero tiene mucha peor IL una vez fuera de rango durante un período prolongado.
...
- [`sdk-api/typescript-sdk`](/es/sdk-api/typescript-sdk) — `raydium.clmm.getOwnerPositionInfo({ programId })` más `PoolUtils.getAmountsFromLiquidity(...)` devuelven la exposición actual; diferencia contra tu base de entrada.
