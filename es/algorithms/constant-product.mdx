...
Precio efectivo: `1000 / 1993.01 ≈ 0.5018`. Spot antes: `0.5`. Slippage respecto al spot: **~0.35%**. El impacto de precio — el movimiento en el precio spot del pool, según la definición anterior — es **~0.20%**.
...
Efectivo: `100_000 / 181_405 ≈ 0.5513`. Slippage respecto al spot: **~10.3%**. Impacto de precio: **~17.3%** — cercano a la regla empírica de `2 · 10% = 20%`, que la comisión de operación y la inversión de la curva sitúan ligeramente por debajo. Los dos números se confunden a menudo: el slippage es lo que paga el swapper en relación con el spot, el impacto de precio es cuánto se mueve la propia cotización del pool.
