...
- **Bug bounty del validador Agave (Anza)** — cubre bugs del cliente validador de Solana (consenso, seguridad, liveness, DoS). Reporta allí para problemas de la capa de Solana; los programas SPL y las propiedades web están explícitamente fuera de alcance. [Política de seguridad de Agave](https://github.com/anza-xyz/agave/security/policy).
- **Squads Protocol Bug Bounty** — cubre el multisig en sí. [docs.squads.so/main/security/bug-bounty](https://docs.squads.so/main/security/bug-bounty).
