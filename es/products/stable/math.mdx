...
La misma aritmética que AMM v4 — consulta [`products/amm-v4/math`](/es/products/amm-v4/math) para la derivación completa — pero con los números propios de los pools Stable.

```
gross_fee = amount_in * (swap_fee_numerator / swap_fee_denominator)    // 2/10_000 = 0.02%
lp_portion = gross_fee - (gross_fee * pnl_numerator / pnl_denominator) // 88% de ella = 0.0176%
pnl_portion = gross_fee * (pnl_numerator / pnl_denominator)            // 12% de ella = 0.0024%
```
