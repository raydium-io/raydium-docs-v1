...
1. **Calcula una relación** a partir de las reservas actuales del pool y utiliza búsqueda binaria para encontrar cuáles dos elementos de la tabla acotan esa relación.
2. **Interpola linealmente** entre los dos puntos que la acotan para obtener el precio de cotización.
3. **Aplica tarifas** (0.02% sobre el monto de entrada) y devuelve el resultado al usuario.
...
- [Tarifas](/es/products/stable/fees) — la tarifa del 0.02% y su división 88 / 12.
