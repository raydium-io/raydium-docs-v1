...
Los mismos 10 USDC compran mucho menos base ahora porque la curva es pronunciada. Resolviendo en `s₀ = 750e6` con `quote_in_after_fee = 9.9e6` da `∆s ≈ 4.4e5` — una reducción de **~200×** en base por USDC comparado con la primera compra.
