...
- Comisiones: `swap_fee = 25/10_000` predeterminado (0.25% del volumen) y `pnl = 12/100` — la relación `Fees` almacenada es 12/100, es decir, el 12% *de la comisión de swap*, lo que equivale al 0.03% del volumen.
...
pnl_share = 2_500_000 * 12 / 100 = 300_000    (va al protocolo vía need_take_pnl_coin)
lp_share  = 2_500_000 − 300_000  = 2_200_000  (se queda en coin_reserve)
