...
`PoolState.tick_array_bitmap` (en línea) cubre el rango "cercano al spot" — **±512** arrays de tick (`TICK_ARRAY_BITMAP_SIZE = 512`; el campo `[u64; 16]` son 1,024 bits divididos por igual entre índices de inicio negativos y positivos, así que índices de array −512 … +511). Fuera de ese rango (para valores de tick extremos), el programa mantiene una cuenta de extensión:
