...
<Info>
  **Banner de versión.** Todos los ejemplos apuntan a `@raydium-io/raydium-sdk-v2@0.2.64-alpha` contra Solana mainnet-beta, verificado 2026-04. El SDK distribuye v3 / v5 / v6 internamente según el propietario del programa de la farm; los ejemplos siguientes asumen una farm v6. Consulta [`reference/program-addresses`](/es/reference/program-addresses) para los tres IDs de programa.
</Info>
