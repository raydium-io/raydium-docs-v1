...
- **Verificado:** 2026-09-09 — el pipeline de abajo coincide llamada por llamada con [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts) frente al SDK `0.2.64-alpha`
