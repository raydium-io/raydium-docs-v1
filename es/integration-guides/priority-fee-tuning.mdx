...
- [Documentación del programa de presupuesto de computación de Solana](https://solana.com/docs/core/fees/compute-budget)

Fuentes:

- [RPC `getRecentPrioritizationFees` de Solana](https://solana.com/docs/rpc/http/getrecentprioritizationfees)
- [API de tarifa de prioridad de Helius](https://www.helius.dev/docs/priority-fee-api)
