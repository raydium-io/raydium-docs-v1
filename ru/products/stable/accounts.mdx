...
- **`fees`** — идентичная AMM v4 *структура*, но другие *значения*: `swap_fee = 2 / 10_000` (0.02%), `pnl = 12 / 100`, `trade_fee = 0`. См. [`products/stable/fees`](/ru/products/stable/fees).
- **`coin_vault`**, **`pc_vault`** — хранилища пула.
- **`status`** — битовая маска, управляющая swap/deposit/withdraw/crank.
