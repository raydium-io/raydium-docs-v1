...
- **Проверено:** 2026-09-09 — конвейер ниже совпадает вызов-за-вызовом с [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts) для SDK `0.2.64-alpha`
