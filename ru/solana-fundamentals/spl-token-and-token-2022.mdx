...
См. [официальную страницу расширений Token-2022](https://www.solana-program.com/docs/token-2022/extensions) для полного списка.
...
- [Token-2022 docs](https://www.solana-program.com/docs/token-2022) — обзор программы; полный список расширений находится по адресу [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions).
