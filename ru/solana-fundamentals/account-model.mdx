...
// Экспортируемый layout — это CpmmPoolInfoLayout, и он уже учитывает
// 8-байтовый дискриминатор — не отрезайте его.
...
- [SPL Token program](https://www.solana-program.com/docs/token) — где живут token accounts.
