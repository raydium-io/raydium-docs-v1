...
`PoolState.tick_array_bitmap` (inline) cobre o intervalo "próximo ao spot" — **±512** arrays de tick (`TICK_ARRAY_BITMAP_SIZE = 512`; o campo `[u64; 16]` tem 1.024 bits divididos igualmente entre índices de início negativos e positivos, portanto índices de array −512 … +511). Fora desse intervalo (para valores de tick extremos), o programa mantém uma conta de extensão:
