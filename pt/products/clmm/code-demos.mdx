...
<Info>
  **Banner de versão.** Todos os exemplos visam `@raydium-io/raydium-sdk-v2@0.2.64-alpha` contra Solana mainnet-beta, verificado em 2026-04. Os IDs de programa vêm de [`reference/program-addresses`](/pt/reference/program-addresses) via o SDK.
</Info>
