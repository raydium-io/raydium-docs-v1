...
A mesma aritmética do AMM v4 — veja [`products/amm-v4/math`](/pt/products/amm-v4/math) para a derivação completa — mas com os números próprios dos pools Stable.

```
gross_fee = amount_in * (swap_fee_numerator / swap_fee_denominator)    // 2/10_000 = 0.02%
lp_portion = gross_fee - (gross_fee * pnl_numerator / pnl_denominator) // 88% dela = 0.0176%
pnl_portion = gross_fee * (pnl_numerator / pnl_denominator)            // 12% dela = 0.0024%
```
