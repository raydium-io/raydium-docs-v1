...
<CardGroup cols={2}>
  ...
  <Card title="Taxas" icon="percent" href="/pt/products/stable/fees">
    Taxa bruta de negociação de 0.02%, dividida em 0.0176% LP / 0.0024% protocolo. Sem taxa de fundo, sem taxa de criador.
  </Card>
...
| **Taxa de negociação** | 0.02% (não os 0.25% do AMM v4) |
| **Participação de LP na taxa** | 0.0176% (88% da taxa) |
| **Participação do protocolo na taxa** | 0.0024% (12% da taxa) |
