...
3. **Aplica taxas** (0,02% do valor de entrada) e retorna o resultado ao usuário.
...
- [Taxas](/pt/products/stable/fees) — a taxa de 0,02% e sua divisão 88 / 12.
