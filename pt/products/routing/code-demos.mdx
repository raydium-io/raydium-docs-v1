...
- **Verificado:** 2026-09-09 — o pipeline abaixo corresponde a [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts) chamada por chamada contra o SDK `0.2.64-alpha`
