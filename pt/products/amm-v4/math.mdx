...
- Taxas: padrão `swap_fee = 25/10_000` (0.25% do volume) e `pnl = 12/100` — a razão `Fees` armazenada é 12/100, isto é, 12% *da taxa de swap*, o que resulta em 0.03% do volume.
...
pnl_share = 2_500_000 * 12 / 100 = 300_000    (vai para protocolo via need_take_pnl_coin)
lp_share  = 2_500_000 − 300_000  = 2_200_000  (permanece em coin_reserve)
