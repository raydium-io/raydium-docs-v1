...
- **Compatível com burn-and-earn.** Os tokens de LP podem ser bloqueados sob o programa [LP Lock](/pt/reference/program-addresses) para que o criador do pool possa continuar coletando taxas sem reter o direito de sacar liquidez. Usado para lançamentos de liquidez "permanente".

## O que o CPMM não é

- **Não é concentrado.** A liquidez é distribuída uniformemente em toda a faixa de preço, como o Uniswap v2. Se você precisa de market making eficiente em capital — ou seja, concentrar liquidez perto do preço atual — use [CLMM](/pt/products/clmm).
...
- [Código-fonte do Raydium CP-Swap — `raydium-io/raydium-cp-swap`](https://github.com/raydium-io/raydium-cp-swap)
