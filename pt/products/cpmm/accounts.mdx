...
| Conta | Seed(s) | Proprietário | Propósito |
|---------|---------|-------|---------|
| `creatorFeeShare` | `"creator_fee_share"`, `creator`, `ammConfig` | CPMM | Substitui `AmmConfig.creator_fee_share_rate` para um criador de pool em um tier de taxa. Opcional — quando não existe, o padrão da configuração se aplica. Adicionado pela atualização de compartilhamento de taxa de criador de 2026-09-19. |
