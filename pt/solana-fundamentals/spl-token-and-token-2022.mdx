...
Veja a [página oficial de extensões Token-2022](https://www.solana-program.com/docs/token-2022/extensions) para a lista completa.
...
- [Documentação SPL Token](https://www.solana-program.com/docs/token).
- [Documentação Token-2022](https://www.solana-program.com/docs/token-2022) — a visão geral do programa; a lista completa de extensões está em [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions).
