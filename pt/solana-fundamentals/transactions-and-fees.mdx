...
O SDK empacota essas instruções automaticamente — via o construtor do próprio tipo de pool (`raydium.cpmm.swap`, `raydium.clmm.swap`, `raydium.liquidity.swap`), ou `raydium.tradeV2.swap` para uma rota multi-hop.
