...
// O layout exportado é CpmmPoolInfoLayout, e ele já contabiliza o
// discriminador de 8 bytes — não o remova.
...
- [Documentação de Contas da Solana](https://solana.com/docs/core/accounts).
- [Programa SPL Token](https://www.solana-program.com/docs/token) — onde contas de token vivem.
