...
| [Perps API](/pt/api-reference/perp-api-v1/overview) | `api-perps-v1.raydium.io` | — | Configurações, metadados de ativos, seleção de RPC para a interface do Raydium Perps. |
