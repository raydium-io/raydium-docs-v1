...
- **Bug bounty do validador Agave (Anza)** — cobre bugs do cliente validador Solana (consenso, segurança, liveness, DoS). Reporte lá para problemas de camada Solana; programas SPL e propriedades web estão explicitamente fora do escopo. [Política de segurança do Agave](https://github.com/anza-xyz/agave/security/policy).
- **Squads Protocol Bug Bounty** — cobre o próprio multisig. [docs.squads.so/main/security/bug-bounty](https://docs.squads.so/main/security/bug-bounty).
