...
Preço efetivo: `1000 / 1993.01 ≈ 0.5018`. Spot antes: `0.5`. Slippage em relação ao spot: **~0.35%**. O impacto de preço — o movimento no preço spot do pool, conforme a definição acima — é **~0.20%**.
...
Efetivo: `100_000 / 181_405 ≈ 0.5513`. Slippage em relação ao spot: **~10.3%**. Impacto de preço: **~17.3%** — próximo da regra de bolso `2 · 10% = 20%`, que a taxa de trade e a inversão da curva puxam ligeiramente para baixo. Os dois números são frequentemente confundidos: slippage é o que o swapper paga em relação ao spot, impacto de preço é quanto a própria cotação do pool se move.
