...
<Info>
  Matriz de suporte: **CPMM** suporta Token-2022 completamente, incluindo mints com taxa de transferência. **CLMM** suporta Token-2022 com taxas de transferência via contas explícitas de `SwapV2`. **AMM v4** não suporta Token-2022 de forma alguma. **LaunchLab** cria um mint base SPL clássico através de `InitializeV2`, mas tem um ponto de entrada dedicado `InitializeWithToken2022` que cria um mint base Token-2022 e opcionalmente anexa um `TransferFeeConfig`; o lado de cotação aceita qualquer um dos programas de token. Veja [`products/launchlab/platform-config`](/pt/products/launchlab/platform-config#token-2022-transfer-fee-authorities). **Farm v6** suporta Token-2022 em mints de staking e recompensas.
</Info>
...
- [Documentação de extensão de taxa de transferência SPL Token-2022](https://www.solana-program.com/docs/token-2022/extensions#transfer-fees)
