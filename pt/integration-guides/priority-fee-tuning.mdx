...
- [Documentação do programa compute budget do Solana](https://solana.com/docs/core/fees/compute-budget)

Fontes:

- [Solana `getRecentPrioritizationFees` RPC](https://solana.com/docs/rpc/http/getrecentprioritizationfees)
- [API de taxa de prioridade Helius](https://www.helius.dev/docs/priority-fee-api)
