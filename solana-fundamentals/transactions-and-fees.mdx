...
The SDK packs these automatically — via the pool type's own builder (`raydium.cpmm.swap`, `raydium.clmm.swap`, `raydium.liquidity.swap`), or `raydium.tradeV2.swap` for a multi-hop route.
