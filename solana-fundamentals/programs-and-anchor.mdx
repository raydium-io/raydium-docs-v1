...
Third-party tools like [Codama](https://github.com/codama-idl/codama) can generate Rust, Go, Python, or JavaScript clients from an IDL. (Codama is the successor to Metaplex's Kinobi, which only ever shipped a JavaScript renderer.)
