...
See the [official Token-2022 extensions page](https://www.solana-program.com/docs/token-2022/extensions) for the full list.
...
- [Token-2022 docs](https://www.solana-program.com/docs/token-2022) — the program overview; the complete extension list is at [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions).
