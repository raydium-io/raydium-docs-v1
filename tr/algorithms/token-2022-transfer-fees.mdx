...
<Info>
  Destek matrisi: **CPMM**, Token-2022'yi tamamen destekler; transfer-fee mint'leri de dahil. **CLMM**, Token-2022'yi açık `SwapV2` hesapları aracılığıyla transfer ücretleriyle destekler. **AMM v4**, Token-2022'yi hiç desteklemez. **LaunchLab**, `InitializeV2` aracılığıyla klasik bir SPL taban mint'i oluşturur, ancak Token-2022 taban mint'i oluşturan ve isteğe bağlı olarak bir `TransferFeeConfig` ekleyen özel bir `InitializeWithToken2022` giriş noktasına sahiptir; quote tarafı her iki token programını da kabul eder. Bkz. [`products/launchlab/platform-config`](/tr/products/launchlab/platform-config#token-2022-transfer-fee-authorities). **Farm v6**, staking ve reward mint'lerinde Token-2022'yi destekler.
</Info>
...
≈ 986.03 USDC. Giden transfer ücreti yok; kullanıcı ≈ 986.03 USDC alır.
...
- [SPL Token-2022 transfer-fee uzantısı belgeleri](https://www.solana-program.com/docs/token-2022/extensions#transfer-fees)
