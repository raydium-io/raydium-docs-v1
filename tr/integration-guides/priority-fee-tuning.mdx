...
- [Solana hesaplama bütçe programı belgeleri](https://solana.com/docs/core/fees/compute-budget)

Kaynaklar:

- [Solana `getRecentPrioritizationFees` RPC](https://solana.com/docs/rpc/http/getrecentprioritizationfees)
- [Helius öncelik ücreti API'si](https://www.helius.dev/docs/priority-fee-api)
