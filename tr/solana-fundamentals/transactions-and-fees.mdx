...
- [Address Lookup Tables teklifi](https://solana.com/developers/cookbook/transactions/lookup-tables).
- [Bilişim bütçesi belgeleri](https://solana.com/docs/core/fees).
