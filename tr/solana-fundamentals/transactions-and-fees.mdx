...
SDK bunları otomatik olarak paketler — havuz türünün kendi oluşturucusu aracılığıyla (`raydium.cpmm.swap`, `raydium.clmm.swap`, `raydium.liquidity.swap`) ya da çok atlamalı bir rota için `raydium.tradeV2.swap` ile.
...
- [Solana İşlem belgeleri](https://solana.com/docs/core/transactions).
- [Address Lookup Tables yemek kitabı kılavuzu](https://solana.com/developers/cookbook/transactions/lookup-tables).
- [Hesaplama bütçesi belgeleri](https://solana.com/docs/core/fees).
