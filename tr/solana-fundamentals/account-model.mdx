...
// Dışa aktarılan düzen CpmmPoolInfoLayout'tur ve 8 baytlık diskriminatörü zaten
// hesaba katar — onu dilimleyip atmayın.
...
- [Solana Hesap belgeleri](https://solana.com/docs/core/accounts).
- [SPL Token programı](https://www.solana-program.com/docs/token) — token hesaplarının yaşadığı yer.
