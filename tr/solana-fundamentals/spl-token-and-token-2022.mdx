...
Tam liste için [resmi Token-2022 uzantıları sayfasına](https://www.solana-program.com/docs/token-2022/extensions) bakın.
...
- [SPL Token belgeler](https://www.solana-program.com/docs/token).
- [Token-2022 belgeler](https://www.solana-program.com/docs/token-2022) — programa genel bakış; tam uzantı listesi [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions) adresindedir.
- [İlişkili Token Hesabı](https://www.solana-program.com/docs/associated-token-account).
