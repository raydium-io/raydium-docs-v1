...
- **Agave doğrulayıcı hata ödülü (Anza)** — Solana doğrulayıcı istemcisi hatalarını kapsar (konsensüs, güvenlik, canlılık, DoS). Solana katmanı sorunları için oraya bildirin; SPL programları ve web mülkleri açıkça kapsam dışıdır. [Agave güvenlik politikası](https://github.com/anza-xyz/agave/security/policy).
- **Squads Protocol Hata Ödülü** — multisig'in kendisini kapsar. [docs.squads.so/main/security/bug-bounty](https://docs.squads.so/main/security/bug-bounty).
