...
- **Doğrulandı:** 2026-09-09 — aşağıdaki hat, SDK `0.2.64-alpha` karşısında [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts) ile çağrı çağrı eşleşiyor
