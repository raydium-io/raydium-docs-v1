...
|---|---|---|
| Phantom | Browser extension, iOS, Android | [phantom.com](https://phantom.com) |
| Solflare | Browser extension, iOS, Android, web | [solflare.com](https://solflare.com) |
| OKX Wallet | Browser extension, iOS, Android | [web3.okx.com](https://web3.okx.com) |
...
The Raydium UI's "Connect Wallet" modal lists every wallet that has integrated with Raydium via the Wallet Adapter. Browse it to see what is currently supported. Solana's official wallet directory ([`solana.com/wallets`](https://solana.com/wallets)) is another neutral starting point — it is filterable by platform, custody model and features.
