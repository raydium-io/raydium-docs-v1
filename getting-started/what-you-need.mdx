...
Any reputable, non-custodial Solana wallet that supports versioned (V0) transactions works with Raydium. Browse the wallet list at [`solana.com/wallets`](https://solana.com/wallets) or open the **Connect Wallet** modal on raydium.io to see currently-integrated options. For a checklist of features that matter when picking one, see [`getting-started/choosing-a-wallet`](/getting-started/choosing-a-wallet).
...
2. **Acquire SOL.** Options:
   ...
   - If you have crypto on Ethereum or another chain: bridge via [portalbridge.com](https://portalbridge.com) or [debridge.com](https://debridge.com).
