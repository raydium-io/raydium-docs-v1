...
- **deBridge** — [debridge.com](https://debridge.com). Bridge + DEX in one: you can send ETH from Ethereum and receive USDC on Solana. Handles the conversion automatically.
