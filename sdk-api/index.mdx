...
<Info>
  **Want to run something first?** Three end-to-end scripts — swap, deploy CPMM pool, deploy CLMM pool — live in [Quick start](/quick-start). The swap and CPMM scripts are single files you paste and run; the CLMM flow takes a few extra steps. Run a real transaction first, then come back here for the full reference.
</Info>
