...
These match the floors on [`solana-fundamentals/toolchain`](/solana-fundamentals/toolchain#python-setup) and the current PyPI releases. `anchorpy` below `0.21` predates the Anchor 1.x IDL format the CPMM and LaunchLab IDLs are now emitted in.
