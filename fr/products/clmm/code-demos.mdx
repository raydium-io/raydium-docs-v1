...
<Info>
  **Bannière de version.** Toutes les démonstrations ciblent `@raydium-io/raydium-sdk-v2@0.2.64-alpha` sur Solana mainnet-beta, vérifiées en avril 2026. Les ID de programme proviennent de [`reference/program-addresses`](/fr/reference/program-addresses) via le SDK.
</Info>
