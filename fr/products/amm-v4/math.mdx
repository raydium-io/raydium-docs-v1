...
- Frais : `swap_fee = 25/10_000` par défaut (0.25% du volume) et `pnl = 12/100` — le ratio `Fees` stocké est 12/100, soit 12% *des frais de swap*, ce qui représente 0.03% du volume.
...
pnl_share = 2_500_000 * 12 / 100 = 300_000    (va au protocole via need_take_pnl_coin)
lp_share  = 2_500_000 − 300_000  = 2_200_000  (reste dans coin_reserve)
