...
| Compte | Seed(s) | Propriétaire | Objectif |
|---------|---------|-------|---------|
| `creatorFeeShare` | `"creator_fee_share"`, `creator`, `ammConfig` | CPMM | Remplace `AmmConfig.creator_fee_share_rate` pour un créateur de pool sur un tier de frais. Optionnel — quand il n'existe pas, la valeur par défaut de la config s'applique. Ajouté par la mise à jour creator-fee-share du 2026-09-19. |
