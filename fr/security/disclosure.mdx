...
- **Prime aux bugs du validateur Agave (Anza)** — couvre les bugs du client validateur Solana (consensus, sûreté, vivacité, DoS). Signalez-y les problèmes au niveau Solana ; les programmes SPL et les propriétés web sont explicitement hors périmètre. [Politique de sécurité d'Agave](https://github.com/anza-xyz/agave/security/policy).
- **Squads Protocol Bug Bounty** — couvre le multisig lui-même. [docs.squads.so/main/security/bug-bounty](https://docs.squads.so/main/security/bug-bounty).
