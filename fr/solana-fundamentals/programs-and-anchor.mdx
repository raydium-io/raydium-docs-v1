...
Les outils tiers comme [Kinobi](https://github.com/metaplex-foundation/kinobi) peuvent générer des clients Rust, Python, C ou Go à partir d'un IDL.
...
- [Déploiement de programme Solana](https://docs.anza.xyz/cli/examples/deploy-a-program).
