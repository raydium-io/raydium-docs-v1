...
```ts
// A positional base58 string on the CPMM module — not an object, not a PublicKey.
const pool = await raydium.cpmm.getPoolInfoFromRpc(POOL_ID);
...
- [Docs de compte Solana](https://solana.com/docs/core/accounts).
- [SPL Token program](https://www.solana-program.com/docs/token) — où vivent les comptes de jetons.
