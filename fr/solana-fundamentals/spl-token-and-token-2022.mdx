...
Consultez la [page officielle des extensions Token-2022](https://www.solana-program.com/docs/token-2022/extensions) pour la liste complète.
...
- [Documentation SPL Token](https://www.solana-program.com/docs/token).
- [Documentation Token-2022](https://www.solana-program.com/docs/token-2022) — l'aperçu du programme ; la liste complète des extensions se trouve à [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions).
