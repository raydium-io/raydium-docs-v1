...
Le SDK empaquète ces instructions automatiquement — via le constructeur propre au type de pool (`raydium.cpmm.swap`, `raydium.clmm.swap`, `raydium.liquidity.swap`), ou `raydium.tradeV2.swap` pour une route multi-hop.
