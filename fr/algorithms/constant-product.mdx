...
pnl_share = swap_fee · pnl_numerator / pnl_denominator               // 12 / 100 = 12% de swap_fee
...
Prix effectif : `1000 / 1993.01 ≈ 0.5018`. Prix au comptant avant : `0.5`. Glissement par rapport au prix au comptant : **~0.35%**. L'impact sur le prix — le déplacement du prix au comptant du pool, selon la définition ci-dessus — est de **~0.20%**.
...
Effectif : `100_000 / 181_405 ≈ 0.5513`. Glissement par rapport au prix au comptant : **~10.3%**. Impact sur le prix : **~17.3%** — proche de la règle empirique `2 · 10% = 20%`, que les frais de transaction et l'inversion de la courbe ramènent légèrement en dessous. Les deux nombres sont souvent confondus : le glissement est ce que paie le swappeur par rapport au prix au comptant, l'impact sur le prix est de combien se déplace la cotation propre du pool.
