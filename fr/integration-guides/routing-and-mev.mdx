...
L'impact total se compose multiplicativement : `(1 - impact_1) * (1 - impact_2)`. Un hop d'impact 1% deux fois, c'est 1,99% total, pas 2%.
...
- [Solana docs on transaction and prioritization fees](https://solana.com/docs/core/fees)
