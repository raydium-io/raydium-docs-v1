...
SDK يحزم هذه تلقائيًا — عبر منشئ نوع المجمع نفسه (`raydium.cpmm.swap` أو `raydium.clmm.swap` أو `raydium.liquidity.swap`)، أو عبر `raydium.tradeV2.swap` لمسار متعدد القفزات.
...
- [وثائق معاملات Solana](https://solana.com/docs/core/transactions).
- [دليل كتاب الطبخ لجداول البحث عن العناوين](https://solana.com/developers/cookbook/transactions/lookup-tables).
