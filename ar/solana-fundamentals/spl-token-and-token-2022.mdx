...
انظر [صفحة ملحقات Token-2022 الرسمية](https://www.solana-program.com/docs/token-2022/extensions) للقائمة الكاملة.
...
- [مستندات SPL Token](https://www.solana-program.com/docs/token).
- [مستندات Token-2022](https://www.solana-program.com/docs/token-2022) — نظرة عامة على البرنامج؛ وقائمة الامتدادات الكاملة موجودة في [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions).
- [حساب التوكن المرتبط](https://www.solana-program.com/docs/associated-token-account).
