...
مقابل حد المعاملة 1,232 بايت، تناسب حوالي 26 تعليمة مرة واحدة بعد حساب تعليمات الميزانية والـ blockhash. **عشرون لكل معاملة** هو رقم العمل الآمن، وهو ما تستخدمه تطبيق Raydium الخاص به. محفظة بـ 116 حساب قابل للاسترجاع تكنس إذاً في ست معاملات، برسم أساسي 5,000 lamports لكل واحدة.
