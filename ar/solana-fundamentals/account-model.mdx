...
// التخطيط المُصدَّر هو CpmmPoolInfoLayout، وهو يحتسب بالفعل مميز الـ 8 بايت
// — لا تقطعه.
...
- [SPL Token program](https://www.solana-program.com/docs/token) — حيث توجد حسابات الرموز.
