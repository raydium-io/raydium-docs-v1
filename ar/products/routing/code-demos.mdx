...
- **تم التحقق منه:** 2026-09-09 — يطابق المسار أدناه [`src/trade/routeSwap.ts`](https://github.com/raydium-io/raydium-sdk-V2-demo/blob/master/src/trade/routeSwap.ts) استدعاءً باستدعاء مقابل SDK `0.2.64-alpha`
