...
<Info>
  **لافتة الإصدار.** جميع الأمثلة تستهدف `@raydium-io/raydium-sdk-v2@0.2.64-alpha` على Solana mainnet-beta، تم التحقق منها في 2026-04. يرسل SDK v3 / v5 / v6 داخليًا بناءً على مالك برنامج المزرعة؛ الأمثلة أدناه تفترض مزرعة v6. انظر [`reference/program-addresses`](/ar/reference/program-addresses) للحصول على معرفات البرنامج الثلاثة.
</Info>
