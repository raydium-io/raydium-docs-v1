...
- [Jupiter Swap API overview](https://developers.jup.ag/docs/swap) — aggregator routing. (`docs.jup.ag` is Jupiter's *user* documentation; the developer docs are on `developers.jup.ag`.)
