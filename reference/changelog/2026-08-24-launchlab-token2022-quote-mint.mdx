...
A new demo subscribes to the LaunchLab program over Yellowstone gRPC and logs, for every `GlobalConfig` and `PoolState` update, whether each mint is a Token or a Token-2022 mint:
