...
<Info>
  A documentation changelog entry for the 2026-08-14 CLMM program update. For the index of all updates, see [`reference/changelog`](/reference/changelog). For the protocol's own historical timeline, see [`introduction/history-and-milestones`](/introduction/history-and-milestones).
</Info>
