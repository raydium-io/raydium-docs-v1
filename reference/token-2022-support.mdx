...
The four keys (CPMM and CLMM × mainnet and devnet) are listed under [Support-mint registry authorities](/reference/program-addresses#support-mint-registry-authorities).
