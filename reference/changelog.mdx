---
title: "Changelog"
description: "Dated record of updates to this documentation set. Entries log which chapters changed, why, and when the content was verified against on-chain state and the program source."
---
