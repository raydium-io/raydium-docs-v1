...
<Update label="2026-08-14" description="LaunchLab: CPMM-only launches and platform config controls">
  ...
  [Read the full entry →](/reference/changelog/2026-08-14-launchlab-cpmm-only-platform-config)
</Update>
...
<Update label="2026-08-14" description="CLMM: restricted-issuer position NFT freezing">
  ...
  [Read the full entry →](/reference/changelog/2026-08-14-clmm-restricted-position-nft-freeze)
</Update>
...
<Update label="2026-08-14" description="CPMM: permissionless creator-fee collection">
  ...
  [Read the full entry →](/reference/changelog/2026-08-14-cpmm-permissionless-creator-fee-collection)
</Update>
