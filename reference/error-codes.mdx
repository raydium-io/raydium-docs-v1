...
The recent LaunchLab releases keep codes `6000`–`6021` unchanged. The 2026-08-17 release removed the former platform-global-access errors and assigned `6022` to the allow-account validation error; the 2026-08-24 release appends `6023`:

| Code | Name | Meaning |
|---|---|---|
| 6018 | `NotEnoughRemainingAccounts` | A required remaining account is missing. This includes a required `PlatformAllowConfig` and the expanded CPMM migration account set. |
