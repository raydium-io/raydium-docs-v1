...
查看[官方 Token-2022 扩展页面](https://www.solana-program.com/docs/token-2022/extensions)获取完整列表。
...
- [SPL Token 文档](https://www.solana-program.com/docs/token)。
- [Token-2022 文档](https://www.solana-program.com/docs/token-2022) —— 程序概览；完整的扩展列表在 [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions)。
- [关联代币账户](https://www.solana-program.com/docs/associated-token-account)。
