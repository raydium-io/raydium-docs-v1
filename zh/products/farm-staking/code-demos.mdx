...
<Info>
  **版本说明。** 所有示例针对 `@raydium-io/raydium-sdk-v2@0.2.64-alpha`，在 Solana mainnet-beta 上验证，时间为 2026-04。SDK 根据农场的程序所有者在内部分发 v3 / v5 / v6；下面的示例假定为 v6 农场。参见 [`reference/program-addresses`](/zh/reference/program-addresses) 了解三个程序 ID。
</Info>
