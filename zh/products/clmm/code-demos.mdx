...
<Info>
  **版本说明。** 所有示例针对 `@raydium-io/raydium-sdk-v2@0.2.64-alpha` 在 Solana mainnet-beta 上运行，已于 2026-04 验证。程序 ID 来自 SDK 中的 [`reference/program-addresses`](/zh/reference/program-addresses)。
</Info>
