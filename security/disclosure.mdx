...
- **Agave validator bug bounty (Anza)** — covers Solana validator-client bugs (consensus, safety, liveness, DoS). Report there for Solana-layer issues; SPL programs and web properties are explicitly out of scope. [Agave security policy](https://github.com/anza-xyz/agave/security/policy).
- **Squads Protocol Bug Bounty** — covers the multisig itself. [docs.squads.so/main/security/bug-bounty](https://docs.squads.so/main/security/bug-bounty).
