...
| Order-book AMM & OpenBook migration | [MadShield, now OShield](https://www.oshield.io/) | Q2 2023 | [View](https://github.com/raydium-io/raydium-docs/blob/master/audit/MadSheild%20Q2%202023/Raydium%20updated%20orderbook%20AMM%20program%20%26%20OpenBook%20migration.pdf) |
| Constant-product AMM (CPMM) | [MadShield, now OShield](https://www.oshield.io/) | Q1 2024 | [View](https://github.com/raydium-io/raydium-docs/blob/master/audit/MadShield%20Q1%202024/raydium-cp-swap-v-1.0.0.pdf) |
...
| CLMM update — Limit Order, Dynamic Fee, Single Asset Fee | [Sec3](https://www.sec3.dev/) | Q2 2026 | [View](https://github.com/raydium-io/raydium-docs/blob/master/audit/Sec3%20Q2%202026/raydium_clmm_limitorder_dynamicfee.pdf) |

Reports are filed under the auditor's name at the time of the review. **MadShield has since rebranded to OShield** (`madshield.xyz` redirects to `oshield.io`), so the two MadShield rows above and the OShield site are the same firm.
