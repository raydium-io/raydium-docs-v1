...
完整清單見[官方 Token-2022 擴展頁面](https://www.solana-program.com/docs/token-2022/extensions)。
...
- [SPL Token 文件](https://www.solana-program.com/docs/token)。
- [Token-2022 文件](https://www.solana-program.com/docs/token-2022) — 程式總覽；完整的擴展清單在 [`/docs/token-2022/extensions`](https://www.solana-program.com/docs/token-2022/extensions)。
- [關聯代幣帳戶](https://www.solana-program.com/docs/associated-token-account)。
