...
<Info>
  **版本說明。** 所有示例針對 `@raydium-io/raydium-sdk-v2@0.2.64-alpha` 運行於 Solana mainnet-beta，已於 2026 年 4 月驗證。SDK 會根據農場的程式所有者內部分配 v3 / v5 / v6；下述示例假設為 v6 農場。請參見 [`reference/program-addresses`](/zh-Hant/reference/program-addresses) 以取得三個程式 ID。
</Info>
