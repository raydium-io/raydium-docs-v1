...
<Info>
  **版本說明。** 所有示例針對 `@raydium-io/raydium-sdk-v2@0.2.64-alpha`，在 Solana mainnet-beta 上驗證，時間為 2026-04。程式 ID：`675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8`（見 [`reference/program-addresses`](/zh-Hant/reference/program-addresses)）。
</Info>
