...
pnl_share = swap_fee · pnl_numerator / pnl_denominator               // 12 / 100 = 12% of swap_fee
...
Effective price: `1000 / 1993.01 ≈ 0.5018`. Spot before: `0.5`. Slippage vs spot: **~0.35%**. Price impact — the move in the pool's spot price, per the definition above — is **~0.20%**.
...
Effective: `100_000 / 181_405 ≈ 0.5513`. Slippage vs spot: **~10.3%**. Price impact: **~17.3%** — close to the `2 · 10% = 20%` rule of thumb, which the trade fee and the curve inversion pull slightly below. The two numbers are often conflated: slippage is what the swapper pays relative to spot, price impact is how far the pool's own quote moves.
